...
document.onclick = function toggleBgColor() {
  if (bgFlag) {
    __WEBPACK_IMPORTED_MODULE_0__src_css_base_css___default.a.use()
    __WEBPACK_IMPORTED_MODULE_1__src_css_common_css___default.a.unuse()
  } else {
    __WEBPACK_IMPORTED_MODULE_1__src_css_common_css___default.a.use()
    __WEBPACK_IMPORTED_MODULE_0__src_css_base_css___default.a.unuse()
  }
  bgFlag = !bgFlag
}
